...
namespace FastReflection.Performance
{
    public class Test
    {
        public Test() { }
    ...
    class Program
    {
        ...
        {
            Console.WriteLine("USE Reflection.Emit");
            int times = 1000000;
            Array.ForEach(new TestResult[]
            {
                TestGetProperties(times),
            ...
            result =>
            {
                ...
                Console.WriteLine(result.Direct.Milliseconds);
                Console.WriteLine(result.Reflection.Milliseconds);
                Console.WriteLine(result.FastReflection.Milliseconds);
                Console.WriteLine(result.RawFastReflection.Milliseconds);
                Console.WriteLine();
            });
        ...
        static TestResult TestGetProperties(int times)
        {
            var obj = new Test();
            ...
            {
                Message = "Get an object properties for " + times + " times."
            };
            ...
            for (int i = 0; i < times; i++)
            {
                var value = obj.GetType().FastGetProperties();
            }
            watch.Stop();
